...
namespace hpp
{
  ...
  : model_ (),
	...
	joint->isBounded (1, true);
	joint->isBounded (2, true);
	joint->lowerBound (0, -1.);
	joint->upperBound (0, +1.);
	joint->lowerBound (1, -1.);
	joint->upperBound (1, +1.);
	joint->lowerBound (2, -1.);
	joint->upperBound (2, +1.);
